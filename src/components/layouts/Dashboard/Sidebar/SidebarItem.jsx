  ...
  return (
    <li>
      <Link
        href={menuItem.path}
        onClick={handleClick}
        className={`${isItemActive ? "rounded-md bg-arx-black-4 text-white" : "text-zinc-400 hover:bg-zinc-800"} group relative flex items-center gap-2.5 px-4 py-2 font-semibold transition-all duration-75`}
      >
        {menuItem.icon}
        {menuItem.label}
        {menuItem.children && (
