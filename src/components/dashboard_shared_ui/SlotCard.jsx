...
// Slot Card Component
const SlotCard = ({ slot,isActive, index,showUpgrade,slotDetails, refetch }) => {
      ...
      {isActive ? (
        <>
          ...
          <div className="flex flex-col gap-3">
            <SubSlots referralCount={slotDetails? slotDetails?.data?.referralCount : 0} subSlots={slot?.subSlots} start={0} end={3} />
            <SubSlots referralCount={slotDetails? slotDetails?.data?.referralCount : 0} subSlots={slot?.subSlots} start={3} />
          </div>
          {/* Recycle Count */}
